...
interface CreativeConfigProps {
    onStart: (data: any) => void;
    onCancel: () => void;
}

export const CreativeConfig: React.FC<CreativeConfigProps> = ({ onStart, onCancel }) => {
        ...
        <div className="w-full h-full flex items-center justify-center p-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
                ...
                <div className={`text-center mb-8 transition-opacity duration-300 ${isLoading ? 'opacity-50' : 'opacity-100'}`}>
                    <h2 className="text-2xl font-semibold text-[var(--text-primary)] mb-1">Configuración Creativa</h2>
                    <p className="text-[var(--text-secondary)] text-sm">Define el contexto para generar ángulos y hooks de alto impacto.</p>
                </div>
                ...
                <div className={`space-y-8 transition-opacity duration-300 ${isLoading ? 'opacity-40 pointer-events-none' : 'opacity-100'}`}>
                    ...
                    {/* 3. Objective */}
                    <div className="space-y-3">
                        <label className="text-[var(--text-primary)] text-sm font-medium block">¿Cuál es el objetivo principal de la campaña?</label>
                    ...
                    {/* 4. Reference Links */}
                    <div className="space-y-3">
                        <label className="text-[var(--text-primary)] text-sm font-medium block">Inspiración visual o narrativa (opcional)</label>
                        <div className="relative">
                            ...
                            <textarea
                                ...
                                placeholder="Pega links de videos, anuncios ganadores o estilos que te gusten..."
                ...
                <div className="mt-10 flex flex-col gap-4">
                    ...
                    >
                        {isLoading ? (
                            ...
                            <>
                                <span>Iniciar Proceso Creativo</span>
                                <ArrowRight size={20} />
                            </>
                        )}
                    </button>
